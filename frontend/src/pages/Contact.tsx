...
export const ContactPage = () => {
  return (
    <div className='rounded-lg bg-amber-50'>
      <ContentFrame>
        <div className='flex flex-col items-center px-6 py-5  text-blue-dark'>
          <h3 className='mb-4 text-2xl sm:text-3xl'>Contact:</h3>
          <p className='border-b border-b-blue-dark px-6 pb-5'>{contactText.en.text}</p>
          ...
          <div className='mt-8 flex gap-8'>
            ...
            >
              <VscGithub className='text-3xl invert-[0.2]  transition-all duration-300 hover:translate-y-0.5 hover:invert-[0.5] sm:text-4xl' />
            </a>
            <a
              ...
              rel='noopener noreferrer'
            >
              <PiLinkedinLogo className='text-3xl invert-[0.2]   transition-all duration-300 hover:translate-y-0.5 hover:invert-[0.5] sm:text-4xl' />
            </a>
          </div>
        </div>
      </ContentFrame>
